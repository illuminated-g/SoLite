...
/**
 * @extends ServiceEntityRepository<ChallengeRun>
 *
...
class ChallengeRunRepository extends ServiceEntityRepository
{
    ...
    public function save(ChallengeRun $entity, bool $flush = false): void
    {
    ...
    public function remove(ChallengeRun $entity, bool $flush = false): void
    {
...
//    /**
//     * @return ChallengeRun[] Returns an array of ChallengeRun objects
//     */
...
//    public function findOneBySomeField($value): ?ChallengeRun
//    {
//        return $this->createQueryBuilder('c')
//            ->andWhere('c.exampleField = :val')
//            ->setParameter('val', $value)
